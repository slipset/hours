...
(defroutes project-routes
  (GET "/" [db user-id] (response (layout/display-projects (prjct/user-projects {:user_id user-id} db))))
  (GET "/add/:client-id" [user-id db client-id] (response (layout/display-add-project (first (client/user-client {:user_id user-id :client_id client-id} db)))))
  (GET "/edit/:project-id" [user-id project-id db] (response (layout/display-edit-project (first (prjct/user-project {:user_id user-id :project_id project-id} db)))))
